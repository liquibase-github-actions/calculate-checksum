...
SECUREPARSING=${95}
SHOULDRUN=${96}
SHOULDSNAPSHOTDATA=${97}
SHOWBANNER=${98}
SHOWHIDDENARGS=${99}
SQLALWAYSSETFETCHSIZE=${100}
SQLLOGLEVEL=${101}
SQLSHOWSQLWARNINGS=${102}
STRICT=${103}
SUPPORTPROPERTYESCAPING=${104}
SUPPORTSMETHODVALIDATIONLEVEL=${105}
SUPPRESSLIQUIBASESQL=${106}
TRIMLOADDATAFILEHEADER=${107}
UISERVICE=${108}
USEPROCEDURESCHEMA=${109}
VALIDATEXMLCHANGELOGFILES=${110}
WORKAROUNDORACLECLOBCHARACTERLIMIT=${111}
